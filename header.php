...
<header class="md:block hidden header-wrapper w-full fixed z-30">
            ...
            >
              ...
              <div>
                ...
                <p
                  class="lg:text-sm text-xs text-bgray-600 font-medium lg:leading-[25.2px]"
                >
              ...
              <div class="quick-access-wrapper relative">
                <div class="flex space-x-[43px] items-center">
                  <div class="xl:flex hidden space-x-5 items-center">
                    <button
                      ...
                      id="notification-btn"
                      type="button"
                      class="w-[52px] h-[52px] rounded-[12px] border border-success-300 flex justify-center items-center relative"
                    >
                      <span
                        class="w-3.5 h-3.5 rounded-full bg-bgray-300 border-2 border-white absolute -right-[5px] -top-[2px]"
                      ></span>
                      <svg
                        width="24"
                        height="25"
                  ...
                  <div
                    ...
                    class="flex lg:space-x-3 space-x-0 cursor-pointer"
                  >
                    <div
                      class="w-[52px] h-[72px] rounded-xxl border border-bgray-300 overflow-hidden"
                    >
                      <img 
                        class="object-cover"
                        src="assets/images/avatar/shutterstock_1240992124.jpg"
                        alt="avater"
                      />
                    </div> 
                  </div>
                ...
                <div id="notification-box" style="
                    ...
                    " class="w-[400px] bg-white absolute -left-[347px] top-[81px] rounded-lg hidden">
                  <div class="w-full pt-[66px] pb-[75px] relative">
                    <div class="w-full h-[66px] flex justify-between items-center absolute left-0 top-0 px-8">
                      <h3 class="text-xl text-bgray-900 font-bold">
                        Notifications
                      </h3>
                      <span>
                    ...
                    <ul class="w-full h-[335px]scroll scroll-style-1">
                    <?php
                    ...
                    ?>  
                      <li class="py-4 pl-6 pr-[50px] hover:bg-bgray-100 border-b border-bgray-200">
                        <a href="#">
                          <div class="noti-item">
                         <p class="font-medium text-sm text-bgray-600 mb-1">
                              <strong class="text-bgray-900"> <?php echo $row['u_name'] ?>:-</strong>
                              Sent an Request To join the Event Group<br>
                              <strong class="text-bgray-900">Event Name: <?php echo $row['e_name'] ?></strong>
                              <!-- totaling
                              <span class="text-success-300">$199.00</span> -->
                            </p>
                            <span class="text-xs font-medium text-bgray-500"><a class="" href="controller/update_status.php?u_id=<?php echo $id; ?>&eid=<?php echo $row['e_id']?>&accept=1">&#x2705; </a></span>   

                            <span class="text-xs font-medium text-bgray-500"><a class="" href="controller/delete_notification.php?u_id=<?php echo $id; ?>&eid=<?php echo $row['e_id']?>"> &#10060; </a></span>   
                          </div>
                        </a> 
                      </li>
                      <?php } ?>
                ...
                <div class="profile-wrapper">
                  <div
                    onclick="profileAction()"
                    class="profile-outside w-full h-full fixed -left-[43px] top-0 hidden"
                  ></div>
                  <div
                    style="
                      filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));
