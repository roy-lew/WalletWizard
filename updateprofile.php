                        ...
                        <form action="controller/updateprofile.php" method="POST">
                          <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
                            ...
                            <div class="flex flex-col gap-2">
                              ...
                              <input
                                type="number"
                                value="<?php echo $row1['monthly_budget']; ?>"
                                class="bg-bgray-50 p-4 rounded-lg h-14 border-0 focus:border focus:border-success-300 focus:ring-0"
                                name="budget"
                              />
                            </div>
                    ...
                    <div class="2xl:col-span-4 xl:col-span-5 2xl:mt-24">
                      <header class="mb-8">
                        ...
                        <div class="text-center m-auto w-60 h-50 relative">
                          <img src="assets/images/avatar/shutterstock_1240992124.jpg" alt="" />
                          <form method="POST">
    <input type="file" name="fileInput" id="fileInput" style="display: none">
    <button class="absolute right-4 bottom-1" type="button" onclick="document.getElementById('fileInput').click()">
