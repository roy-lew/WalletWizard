...
<h3
                      ...
                      <table class="w-full">
                        ...
                        <a href="updatecategory.php?cid=<?php echo $row['c_id']; ?>">
                          <span
                            class="block bg-[#FDF9E9] text-[#9AA2B1] rounded-md px-4 py-1.5 leading-[22px] text-sm font-semibold"
                            ><?php echo $row2['exp_amount']?>Update</span
                          ></a> 
                                </div>
                        </td>
                          <td class="py-5 px-6 xl:w-[165px] xl:px-0">
                            <div class="w-full flex items-center">
                             <a onclick="return confirm('Are you sure!!')" href="controller/deletecategory.php?cid=<?php echo $row['c_id']; ?>"><span
