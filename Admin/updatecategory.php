 ...
 <?php include 'sidebar.php'?>
      ...
      <main
         ...
         <div class="form-group">
            <form action="controller/updatecategory.php?cid=<?php echo $cid ?>" method="POST">
         ...
         <ul class="py-7 border-t border-b">
                ...
                >
                 Update Category
                </h3><br><input style="margin-right:550px" value="<?php echo $row['c_name'] ?>" class="text-bgray-800 text-base border border-bgray-300 h-14 w-half focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" type="text" name="c_name"
                      >
                      </li>
