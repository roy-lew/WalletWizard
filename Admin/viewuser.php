...
<h3
                      ...
                      <table class="w-full">
                        <tr class="border-b border-bgray-300">
                          ...
                          <td class="py-5 px-6 xl:px-20">
                            <div class="flex space-x-12.5 items-center">
                              <span
                                class="text-base font-medium text-bgray-600"
                              >
                                Address</span
                        ...
                        <tr class="border-b border-bgray-300">
                            <?php
                                $stmt2=$admin->ret("SELECT * FROM `user`");
                          ...
                          <td class="py-5 px-6 xl:px-0">
                            ...
                            >
                              ...
                              <p class="font-semibold text-base text-bgray-900">
                                <?php echo $row2['u_name']?>
                              </p>
                            </div>
                          </td>
                          <td class="py-5 px-6 xl:px-10">
                            <p class="font-medium text-base text-bgray-900">
                                <?php echo $row2['u_email']?>
                                </p>
                            
                          </td>
                          <td class="py-5 px-6 xl:px-10">
                            <p class="font-medium text-base text-bgray-900">
                            <?php echo $row2['u_contact']?>
                            </p>
                          </td> 
                          <td class="py-5 px-6 xl:px-13">
                            <p class="font-medium text-base text-bgray-900">
                            <?php echo $row2['u_address']?>
                            </p>
                          </td> 
                        </tr>
                        <?php } ?>
